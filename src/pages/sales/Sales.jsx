...
export default function Sales() {
  ...
  async function handleUpdateSale(
    ...
    try {
      ...
      console.error(
        "Gagal memperbarui penjualan:",
        error
      );

      setPageError(
        error.message ||
          "Penjualan gagal diperbarui."
      );
    } finally {
      setSaving(false);
    }
  ...
  async function handleDeleteSale(
    ...
    const confirmed =
      window.confirm(
        `Hapus catatan penjualan tanggal ${formatDate(
          sale.saleDate
  ...
  if (loading) {
    return (
      <LoadingState message="Memuat data penjualan..." />
    );
  }
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Catat produk yang terjual tanpa
